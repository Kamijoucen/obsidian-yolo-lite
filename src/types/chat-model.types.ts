 ...
 * `tools` / `extra_body` request slot using OpenAI's hosted web-search shape.
 */
...
export const chatModelSchema = z.object({
  ...
  reasoningType: z.enum(['none', 'openai']).optional(),
  ...
  // Whether to enable OpenAI hosted tools for this model.
  builtinToolProvider: z.enum(['none', 'gpt']).default('none').optional(),
